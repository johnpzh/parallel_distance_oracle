...
//                if (CAS((void *) (&lock), static_cast<char>(0), static_cast<char>(1))) {
//                    SI_v_tail.indicator.set(label_root_id);
//                } else {
//                    continue;
//                }
...
//                else {
//                    printf("L%u: T%u: B%u: l_i: %u "
//                           "short_index[%u].indicator[%u]: %u\n",
//                           __LINE__, omp_get_thread_num(), roots_start / BATCH_SIZE, l_i,
